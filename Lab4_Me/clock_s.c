...
extern const MIDL_SERVER_INFO clock_ServerInfo;

extern const RPC_DISPATCH_TABLE clock_v1_0_DispatchTable;

static const RPC_SERVER_INTERFACE clock___RpcServerInterface =
    {
    sizeof(RPC_SERVER_INTERFACE),
    {{0xf59c1760,0x85da,0x4e2e,{0xa6,0x62,0x1c,0xbd,0xef,0xe3,0x84,0x1b}},{1,0}},
    {{0x8A885D04,0x1CEB,0x11C9,{0x9F,0xE8,0x08,0x00,0x2B,0x10,0x48,0x60}},{2,0}},
    (RPC_DISPATCH_TABLE*)&clock_v1_0_DispatchTable,
    0,
    0,
    0,
    &clock_ServerInfo,
...
RPC_IF_HANDLE clock_v1_0_s_ifspec = (RPC_IF_HANDLE)& clock___RpcServerInterface;
#ifdef __cplusplus
namespace {
#endif
...
static const RPC_DISPATCH_FUNCTION clock_table[] =
    {
    NdrServerCall2,
    NdrServerCall2,
    0
    };
static const RPC_DISPATCH_TABLE clock_v1_0_DispatchTable = 
    {
    2,
    (RPC_DISPATCH_FUNCTION*)clock_table
    };
...
static const MIDL_STUB_DESC clock_StubDesc = 
    {
    (void *)& clock___RpcServerInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    0,
    0,
    ...
    0x2000001, /* MIDL flag */
    0, /* cs routines */
    (void *)& clock_ServerInfo,   /* proxy/server info */
    0
    };
#ifdef __cplusplus
}
...
static const RPC_DISPATCH_FUNCTION clock_NDR64__table[] =
    {
    NdrServerCallAll,
    NdrServerCallAll,
    0
    };
static const RPC_DISPATCH_TABLE clock_NDR64__v1_0_DispatchTable = 
    {
    2,
    (RPC_DISPATCH_FUNCTION*)clock_NDR64__table
    };
...
static const MIDL_SYNTAX_INFO clock_SyntaxInfo [  2 ] = 
    ...
    ,{
    {{0x71710533,0xbeba,0x4937,{0x83,0x19,0xb5,0xdb,0xef,0x9c,0xcc,0x36}},{1,0}},
    (RPC_DISPATCH_TABLE*)&clock_NDR64__v1_0_DispatchTable,
    0 ,
...
static const SERVER_ROUTINE clock_ServerRoutineTable[] = 
    {
    (SERVER_ROUTINE)GetTime,
    (SERVER_ROUTINE)GetDate
    };

static const MIDL_SERVER_INFO clock_ServerInfo = 
    {
    &clock_StubDesc,
    clock_ServerRoutineTable,
    clock__MIDL_ProcFormatString.Format,
    (unsigned short *) clock_FormatStringOffsetTable,
    0,
